...
const RepositoryDetail = () => {
  ...
  if (error) {
    return <Error message={error} onRetry={loadRepositoryData} />;
  }
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="mb-8">
        <ol className="flex items-center space-x-2 text-sm text-gray-500">
          ...
          <li className="text-gray-900 font-medium">{repository.name}</li>
        </ol>
      </nav>
        ...
        <div className="card p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{repository.stargazersCount}</p>
            </div>
        ...
        <div className="card p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{repository.forksCount}</p>
            </div>
        ...
        <div className="card p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{repository.watchersCount}</p>
            </div>
        ...
        <div className="card p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{repository.openIssuesCount}</p>
            </div>
